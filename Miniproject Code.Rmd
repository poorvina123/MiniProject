...
Variables obtained from World Bank ESG Data Portal: (INSERT)
Socio-economic variables obtained from World Bank DataBank: National Income per Capita (US$), GDP per Capita (US$), Population Growth (%), Sex Ratio
